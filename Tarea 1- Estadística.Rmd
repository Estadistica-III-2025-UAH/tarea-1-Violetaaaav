...
title: "Tarea N°1" subtitle: "Universidad Alberto Hurtado - Estadística III" author: "Estudiante: Violeta Paz Rivera Sepúlveda - Profesor: Mauricio Carrasco - Ayudante: Vicente Díaz" date: "2025-03-30" output: html_document
...
```{r, echo=FALSE}
knitr::include_graphics("grafico01.jpg")
```
